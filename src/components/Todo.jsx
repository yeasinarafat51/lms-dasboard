...
const Todo = () => {
  return (
    <div className="w-[289px] h-[273px] p-3 bg-white rounded-lg shadow-xl overflow-hidden">
      ...
      {/* Content Section */}
      <h2 className="text-[15px]   font-inter font-bold text-gray-800">
        To do List
      </h2>
      <div className="flex items-center py-2 gap-4 px-4   bg-white text-black  border-b-2 bottom-2 border-b-[#E4E4E4]  mx-auto">
        ...
        <div className=" ">
          <p className="text-[14px] font-bold font-inter text-[#121212]">
            Human Interaction Designs
          </p>
          <p className="text-[13px] font-bold font-inter text-[#41475E]">
      ...
      <div className="flex items-center py-2 gap-4 px-4   bg-white text-black  border-b-2 bottom-2 border-b-[#E4E4E4]  mx-auto">
        ...
        <div className=" ">
          <del className="text-[14px] font-bold font-inter text-[#121212]">
            Introduction to UI
          </del>
          <p className="text-[13px] font-bold font-inter text-[#41475E]">
            Friday, 10 June 2024
